      ...
      <div class="row g-0">
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="http://localhost/project//elephant1.php">
              <img src="assets/img/elephant/elephant1.jpg" alt="" class="img-fluid">
            </a>
          </div>
          <br><br><center>
          <div class="section-title">
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="http://localhost/project//elephant2.php">
              <img src="assets/img/elephant/elephant2.jpg" alt="" class="img-fluid">
            </a>
          </div>
          <br><br><center>
          <div class="section-title">
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="http://localhost/project//elephant3.php">
              <img src="assets/img/elephant/elephant3.jpg" alt="" class="img-fluid">
            </a>
          </div>
          <br><br><center>
          <div class="section-title">
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="http://localhost/project/elephant4.php">
              <img src="assets/img/elephant/elephant4.jpg" alt="" class="img-fluid">
            </a>
          </div>
