        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
            <div class="gallery-item">
              <a href="assets/img/changidea.jpg">
                <img src="assets/img/changidea.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <div class="section-title">
              <h2>ความเชื่อเกี่ยวกับช้างในประเทศไทย</h2>
            </div>
            <p>
              ช้างเป็นสัตว์ที่มีประโยชน์มาก มีกำลังแข็งแรงยิ่งกว่าสัตว์ทั้งปวง และรู้จักภาษามนุษย์ได้ดี ทำให้มนุษย์นับถือและเอ็นดูช้างมาก
              และถ้าจะกล่าวถึงรูปลักษณ์แล้ว ช้างในประเทศไทยเป็นช้างที่งามที่สุด เพราะมีรูปร่างที่ได้สัดส่วนกัน
              และที่พิเศษก็คือประเทศไทยมีช้างเผือก ที่มีผิวหนังเป็นสีชมพูแกมเทา นัยน์ตา และเล็บขาว
              คนไทยมีความเชื่อว่ามนุษย์เมื่อสิ้นชีพไปแล้ววิญญาณจะไปสิงอยู่ในร่างกายของสัตว์ต่าง ๆ ได้
              และวิญญาณของสัตว์เมื่อล้มตายไปแล้วก็สามารถที่จะเข้ามาสิงอยู่ในร่างกายของมนุษย์ได้เช่นกัน ดังนั้นคนไทยจึงไม่ใคร่ฆ่าสัตว์
              เพราะเกรงว่าจะไปฆ่าเอาสัตว์ที่มีวิญญาณของพี่น้องของตนเข้าไปสิงอยู่ และเชื่อกันว่าวิญญาณของพระเจ้าแผ่นดินหรือผู้กล้าหาญในการสงคราม
              เมื่อสังขารแตกดับลงแล้วก็จะเข้าไปสิงอยู่ในร่างกายของช้างเผือก ด้วยเหตุนี้เองคนไทยจึงนับถือช้างเผือกมาก
