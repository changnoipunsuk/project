...
<main id="main">
  ...
  <div class="row">
      <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
        <div class="about-img">
          <a href="assets/img/elephant/elephant3.jpg" class="gallery-lightbox" data-gall="gallery-item">
      ...
      <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
        ...
        <h2>ชื่อ ไพลิน,เหมยลี่</h2>
        </div>
        <p class="elephant">
          -อายุ 9 ปี <br>
          -เพศเมีย <br>
          -เกิดวันที่ 25 มิถุนายน พ.ศ.2558 <br>
          -ประเภท ช้างบ้าน <br>
          -ชอบกินผัก ผลไม้
        </p>
      </div>
