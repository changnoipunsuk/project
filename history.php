    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="gallery-item">
          <a href="assets/img/gallery/history.jpg">
            <img src="assets/img/gallery/history.jpg" alt="" class="img-fluid">
          </a>
        </div>
        </div>
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
          ...
          ก่อให้เกิด ผลกระทบ ทำให้รายได้จากการท่องเที่ยวเป็นศูนย์ ควาญช้างไม่มีรายได้ เข้ามาเลี้ยงครอบครัว ชื้ออาหารให้ช้าง
          อีกทั้ง ปางช้าง ยังต้องปิดตัวโดยไม่มีกำหนดการ ทำให้ ช้างตกงาน
          ในขณะที่ช้างจะกินอาหารประมาณ ร้อยละ 10 ของนํ้าหนักตัวต่อวัน หรือประมาณวันละ 250-280 กิโลกรัม ต่อเชือก 
          จึงต้องมีการหารายได้ เพื่อความอยู่รอดของควาญช้างและช้างเพื่อนร่วมโลก จึงมีความประสงค์ที่จะจัดสร้าง คณะช้างน้อยปัญสุข ขึ้นมา
          </p>
