      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="member" data-aos="zoom-in" data-aos-delay="100">
            <img src="assets/img/creator/cop.jpg" class="img-fluid" alt="">
            <div class="member-info">
              <div class="member-info-content">
                <h4>รัชชานนท์ พันธรักไพรวัลย์</h4>
                <span>---</span>
              </div>
              <div class="social">
                <a href="https://www.facebook.com/ratchanon.phantharakphaiwan" target="_blank"><i class="bi bi-facebook"></i></a>
                <a href="https://www.instagram.com/9ine_cz/" target="_blank"><i class="bi bi-instagram"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="member" data-aos="zoom-in" data-aos-delay="200">
            <img src="assets/img/creator/fait.jpg" class="img-fluid" alt="">
            <div class="member-info">
              <div class="member-info-content">
                <h4>ภาณุวัฒน์ ประเสริฐ</h4>
                <span>---</span>
              </div>
              <div class="social">
                <a href="https://www.facebook.com/fait.kub.9/" target="_blank"><i class="bi bi-facebook"></i></a>
                <a href="https://www.instagram.com/pa_nuwat_x/" target="_blank"><i class="bi bi-instagram"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="member" data-aos="zoom-in" data-aos-delay="300">
            <img src="assets/img/creator/ice.jpg" class="img-fluid" alt="">
            <div class="member-info">
              <div class="member-info-content">
                <h4>วีรวัฒน์ โพธิ์จวง</h4>
                <span>---</span>
              </div>
              <div class="social">
                <a href="https://www.facebook.com/wxxrawat" target="_blank"><i class="bi bi-facebook"></i></a>
                <a href="https://www.instagram.com/weeeeeeeeeerawat/" target="_blank"><i class="bi bi-instagram"></i></a>
              </div>
            </div>
          </div>
        </div>
