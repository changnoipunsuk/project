        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                ...
                ชื่อ นายชยพล พันธรักไพรวัลย์ อายุ 52
                เคยทำงานที่ปางช้างแม่ตะมาน พ.ศ.2544
                เริ่มก่อตั้งคณะช้างน้อยปันสุขปี พ.ศ.2563
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <div class="about-img">
                </a>
              </div>
              <a href="assets/img/testimonials/ow.jpg">
              <img src="assets/img/testimonials/ow.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>นายชยพล พันธรักไพรวัลย์</h3>
              <h4>เจ้าของคณะช้างน้อยปันสุข</h4>
            </div>
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                ชื่อ นายชัยมงคล   คะเนนอก อายุ 27
                เริ่มทำงานที่คณะช้างน้อยปันสุข พ.ศ.2563
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <div class="about-img">
                </a>
              </div>
              <a href="assets/img/testimonials/t1.jpg">
              <img src="assets/img/testimonials/t1.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>ชื่อ นายชัยมงคล   คะเนนอก</h3>
              <h4>ควาญช้าง</h4>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                ชื่อ นายอาคเนย์ คะเนนอก อายุ 24
                เริ่มทำงานที่คณะช้างน้อยปันสุข พ.ศ.2563
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <div class="about-img">
              ...
              <a href="assets/img/testimonials/t2.jpg">
              <img src="assets/img/testimonials/t2.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>ชื่อ นายอาคเนย์ คะเนนอก</h3>
              <h4>ควาญช้าง</h4>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                ชื่อ นายตะวัน หมู่บำรุง อายุ 25
                เริ่มทำงานที่คณะช้างน้อยปันสุข พ.ศ.2563
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <div class="about-img">
              ...
              <a href="assets/img/testimonials/t3.jpg">
              <img src="assets/img/testimonials/t3.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>ชื่อ นายตะวัน หมู่บำรุง</h3>
              <h4>ควาญช้าง</h4>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                ชื่อ นายพรทิพ เสธวิสัย อายุ 25
                เริ่มทำงานที่คณะช้างน้อยปันสุข พ.ศ.2563
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <div class="about-img">
              ...
              <a href="assets/img/testimonials/t4.jpg">
              <img src="assets/img/testimonials/t4.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>ชื่อ นายพรทิพ เสธวิสัย</h3>
              <h4>ควาญช้าง</h4>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                ชื่อ นายชัยวัฒน์ สุวรรณมา อายุ 22
                เริ่มทำงานที่คณะช้างน้อยปันสุข พ.ศ.2563
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <div class="about-img">
              ...
              <a href="assets/img/testimonials/t5.jpg">
              <img src="assets/img/testimonials/t5.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>ชื่อ นายชัยวัฒน์ สุวรรณมา</h3>
              <h4>ควาญช้าง</h4>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              ...
              <a href="assets/img/testimonials/t6.jpg">
              <img src="assets/img/testimonials/t6.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>ชื่อ นายเอกวิน จะลา</h3>
              <h4>ควาญช้าง</h4>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                ชื่อ นางสาววรัญญา จะหวะ อายุ 22
                เริ่มทำงานที่คณะช้างน้อยปันสุข พ.ศ.2563
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <div class="about-img">
              ...
              <a href="assets/img/testimonials/t7.jpg">
              <img src="assets/img/testimonials/t7.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>ชื่อ นางสาววรัญญา จะหวะ</h3>
              <h4>ควาญช้าง</h4>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                ชื่อ นางสุวนันท์ พันธรักไพรรวัลย์ อายุ 52
                เริ่มทำงานที่คณะช้างน้อยปันสุข พ.ศ.2563
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <div class="about-img">
              ...
              <a href="assets/img/testimonials/t8.jpg">
              <img src="assets/img/testimonials/t8.jpg" class="testimonial-img" alt="" class="img-fluid">
              </a>
              <h3>ชื่อ นางสุวนันท์ พันธรักไพรรวัลย์</h3>
              <h4>ควาญช้าง</h4>
            </div>
          </div><!-- End testimonial item -->
