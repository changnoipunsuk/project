    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="gallery-item">
          <a href="assets/img/gallery/care.jpg">
            <img src="assets/img/gallery/care.jpg" alt="" class="img-fluid">
          </a>
        </div>
        </div>
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
          ...
          <p>
            เมื่อฝึกช้างจนเชื่อฟังมีความเข้าใจคำสั่งแล้วการเลี้ยงช้างนั้นให้มีความสุขให้รักเจ้าของเชื่อฟังไม่ทำร้ายเจ้าของก็เป็นสิ่งสำคัญที่ต้องให้ความสำคัญ 
            เพราะควาญช้างผู้ดูแลเลี้ยงช้างต้องใช้เวลาส่วนใหญ่ในแต่ละวันไปกับช้าง แต่ที่ต่างกันก็คือความเสี่ยงที่ควาญช้างทุกคนต้องตระหนักเมื่อคิดจะเลี้ยงช้าง 
            เพราะถ้าพลั้งเผลอไปหรือหากช้างไม่พอใจ หรือแม้แต่ช้างตกใจก็อาจถูกช้างฆ่าตายได้ในชั่วพริบตา ดังนั้นการเลี้ยงช้างจึงจำเป็นจะต้องเป็นคนที่มีคุณสมบัติหลายประการ 
            คือ รักสัตว์ มีความกล้าหาญ มีความขยันอดทนและต้องเป็นคนที่ช่างสังเกต นอกจากนี้ช้างยังเป็นสัตว์พิเศษที่จะเชื่อฟังและยอมรับเฉพาะควาญผู้ใกล้ชิด 
            แต่จะไม่ยอมรับทุกคนเหมือนกับสัตว์เลี้ยงทั่วไปในบ้านอย่างสุนัขหรือแมว เพราะช้างนั้นจะยอมรับและทำตามคำสั่งเฉพาะควาญที่เลี้ยงเขา 
            ซึ่งเรื่องนี้เป็นศาสตร์และศิลป์ที่ได้รับการถ่ายทอดกันมาจากรุ่นหนึ่งสู่อีกรุ่นหนึ่งอย่างไม่ขาดสาย
          </p>
          <br>
          <div class="section-title">
            <h2>วิธีที่ควาญสื่อสารกับช้าง</h2>
          </div>
          <p>
          การสื่อสารกับช้างเป้นสิ่งจำเป็น เพื่อควาญจะได้รู้จักนิสัยและอารมณ์ของช้าง ขณะเดียวกันช้างก็จะได้รู้ความต้องการของควาญ 
         มีวิธีสื่อสารกับช้างหลายวิธีและจะเลือกใช้ตามความเหมาะสมซึ่งทั้งหมดควาญและช้างจะต้องเรียนรู้จากกันและกัน
        </p>
        </div>
      </div>
